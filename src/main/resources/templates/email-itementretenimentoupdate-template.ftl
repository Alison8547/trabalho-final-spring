                ...
                <tr>
                    <td align="center" valign="top" bgcolor="#d3be6c"
                        ...
                        <div>
                            ...
                            <br> <br> <b>${nome} sofreu alterações !</b>
                            <br> <br> <b>é um(a) ${tipo}, lançada em ${ano} e sua classificação é ${classificacao}</b>
                            <br> <br> <b>seu genero é de ${genero} e tem uma duração total de ${duracao}</b>
                            <br> <br> <b>Nós da DBCMovies estamos trabalhando sempre para manter nossos conteúdos atualizados para você !</b>
