                ...
                <tr>
                    <td align="center" valign="top" bgcolor="#d3be6c"
                        ...
                        <div>
                            ...
                            <br> <br> <b>Olá ${nome}</b>
                            <br> <br> <b>Estamos felizes em ter você em nosso sistema :)</b>
                            <br> <br> <b>Seu cadastro foi realizado com sucesso, seu indentificador ${id}</b>
                            <br> <br> <b>Seu email cadastrado: ${emailUsuario}</b>
                            <br> <br> <b>Seu tipo de Usuario: ${tipoUsuario}</b>
